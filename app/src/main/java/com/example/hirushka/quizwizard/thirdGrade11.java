...
public class thirdGrade11 extends AppCompatActivity {
    ...
    int category;
    public static final String QUIZ_CATEGORY123 = "passing quiz category";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_third_grade11);
    ...
    public void startquiz(View view) {
        ...
        Intent intent = new Intent(thirdGrade11.this,quiz101.class);
        intent.putExtra(QUIZ_CATEGORY123,category);
