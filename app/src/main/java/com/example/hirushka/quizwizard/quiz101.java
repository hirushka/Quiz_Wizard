...
public class quiz101 extends AppCompatActivity {
    ...
    String quizdata1[][] = qb1.getQuizdata1();
    String quizdata2[][] = qb1.getQuizdata2();
    String quizdata3[][] = qb1.getQuizdata3();
    String quizdata4[][]= qb1.getQuizdata4();
    String quizdata5[][] = qb1.getQuizdata5();


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_quiz101);
        ...
        category = intent.getIntExtra(thirdGrade10.QUIZ_CATEGORY,0);
            ...
            public void onClick(View v) {
                ...
                if(!answered) {
                    if (radiobtn1.isChecked() || radiobtn2.isChecked() || radiobtn3.isChecked() || radiobtn4.isChecked()) {
                        ...
                        Toast.makeText(quiz101.this, "select the answer" , Toast.LENGTH_SHORT).show();
            ...
            public void onClick(View v) {
                if(quizCount<QUIZ_COUNT) {
                  //  quizCount++;
                    ...
                    Intent intent = new Intent(quiz101.this,ResultActivity.class);
